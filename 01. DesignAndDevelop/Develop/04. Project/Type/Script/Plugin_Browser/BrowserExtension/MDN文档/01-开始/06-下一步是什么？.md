---
title: "下一步是什么？"
source: "https://developer.mozilla.org/zh-CN/docs/Mozilla/Add-ons/WebExtensions/What_next"
author:
published: 2025-08-05
created: 2026-05-02
description: "现在你可以将你对浏览器扩展的想法变成现实了。在开始这个过程之前，值得了解一些有助于使其顺利进行的事情。"
tags:
  - "clippings"
---
...
- 更多关于浏览器扩展背后的基本概念，从如何 [使用 JavaScript API](https://developer.mozilla.org/zh-CN/docs/Mozilla/Add-ons/WebExtensions/API) 的细节开始。
- 可供浏览器扩展使用的 [用户界面组件](https://developer.mozilla.org/zh-CN/docs/Mozilla/Add-ons/WebExtensions/user_interface) 的指南。
- 一系列关于如何在扩展中实现关键任务与运用 JavaScript API 的指南。
- [JavaScript API](https://developer.mozilla.org/zh-CN/docs/Mozilla/Add-ons/WebExtensions/Browser_support_for_JavaScript_APIs) 的完整参考指南。
- [Manifest 键](https://developer.mozilla.org/zh-CN/docs/Mozilla/Add-ons/WebExtensions/manifest.json) 的完整参考指南。
