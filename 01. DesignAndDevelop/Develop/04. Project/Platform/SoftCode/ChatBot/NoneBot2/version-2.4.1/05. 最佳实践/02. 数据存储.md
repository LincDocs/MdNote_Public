...
在使用前请先安装 `nonebot-plugin-localstore` 插件至项目环境中，可参考[获取商店插件](../02.%20指南/03.%20获取商店内容.mdx.md#安装插件)来了解并选择安装插件的方式。如：
...
在使用本插件前同样需要使用 `require` 方法进行**加载**并**导入**需要使用的方法，可参考 [跨插件访问](../04.%20进阶/05.%20跨插件访问.md) 一节进行了解，如：
