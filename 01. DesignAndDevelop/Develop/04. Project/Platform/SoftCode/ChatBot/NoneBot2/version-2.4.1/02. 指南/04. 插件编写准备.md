...
:::caution 注意
如果在之前的[创建项目](01.%20手动创建项目.md)章节中手动创建了相关文件，那么你需要做出如下修改：
...
有关其他插件加载的方式，可参考[跨插件访问](../04.%20进阶/05.%20跨插件访问.md)和[嵌套插件](../04.%20进阶/04.%20嵌套插件.md)。
