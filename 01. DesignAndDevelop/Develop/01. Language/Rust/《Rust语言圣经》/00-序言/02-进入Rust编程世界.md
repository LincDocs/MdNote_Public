...
source: https://beatai.org/rust-course/into-rust
---
# 进入Rust编程世界
...
要学好 Rust，你需要深入理解**内存、堆栈、引用、变量作用域等**这些其它高级语言往往不会深入接触的内容。另外，Rust 会通过语法、编译器和 clippy 这些静态检查工具半帮助半强迫的让你成为更优秀的程序员，写出更好的代码。
...
正因为这较高的质量下限，我们在代码 review 时不用过于担心潜在的各种坑，得益于此，可以实现**更加高效的开发、review、merge 流程**。
...
目前 Rust 的主战场是在开源上，Go 的成功也证明了**农村包围城市 (开源包围商业)** 的可行性。
