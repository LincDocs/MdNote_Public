...
source: https://beatai.org/rust-course/advance/concurrency-with-threads/thread
---
# 使用多线程
...
在[闭包](https://beatai.org/rust-course/advance/functional-programing/closure#move-%E5%92%8C-fn)章节中，有讲过 `move` 关键字在闭包中的使用可以让该闭包拿走环境中某个值的所有权，同样地，你可以使用 `move` 来将所有权从一个线程转移到另外一个线程。
