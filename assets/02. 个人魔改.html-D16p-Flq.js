...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">@theme-hope/modules/sidebar/utils/index</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> 侧边栏通用函数</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但还是需要子项目，否则虽然能用但有bug （import scss时失效）</p><h3 id="最终版" tabindex="-1">最终版</h3><ol><li>配置：workspace + 子项目</li><li>修改：别名？</li><li>运行：子项目编译 + 父项目编译</li><li>后续修改：修改替换组件 + 孙子项目编译 + 父项目编译</li></ol><h2 id="设置修改项" tabindex="-1">设置修改项</h2><h2 id="源码修改项" tabindex="-1">源码修改项</h2>`,25)])])}const d=l(r,[["render",h]]),o=JSON.parse('{"path":"/01.%20DesignAndDevelop/Develop/04.%20Project/Type/Doc/MarkdwonAbout/01.%20Soft%20And%20Frame/VuePress2%20(Vue3)/03.%20%E4%B8%BB%E9%A2%98%E6%89%A9%E5%B1%95/Hope%E4%B8%BB%E9%A2%98/09.%20Private/02.%20%E4%B8%AA%E4%BA%BA%E9%AD%94%E6%94%B9.html","title":"个人魔改","lang":"zh-CN","frontmatter":{"description":"个人魔改 魔改内容 总结 需要修改的内容 侧边栏部分，文件夹化 (主要得修改主题源码) ✅ 点击另一处不自动折叠 ✅ 目录名（任何时候都应当以文件名为主，而非h1的名字，哪怕是README.md） 同时解决无h1时会产生bug的问题 使用懒加载，否则当路径上千时，打开页面贼慢 (可能较难，但不弄的话网差要10s+才能加载出页面) 根前缀指定 (用户可选...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"个人魔改\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/04.%20Project/Type/Doc/MarkdwonAbout/01.%20Soft%20And%20Frame/VuePress2%20(Vue3)/03.%20%E4%B8%BB%E9%A2%98%E6%89%A9%E5%B1%95/Hope%E4%B8%BB%E9%A2%98/09.%20Private/02.%20%E4%B8%AA%E4%BA%BA%E9%AD%94%E6%94%B9.html"}],["meta",{"property":"og:site_name","content":"MdNote_Public"}],["meta",{"property":"og:title","content":"个人魔改"}],["meta",{"property":"og:description","content":"个人魔改 魔改内容 总结 需要修改的内容 侧边栏部分，文件夹化 (主要得修改主题源码) ✅ 点击另一处不自动折叠 ✅ 目录名（任何时候都应当以文件名为主，而非h1的名字，哪怕是README.md） 同时解决无h1时会产生bug的问题 使用懒加载，否则当路径上千时，打开页面贼慢 (可能较难，但不弄的话网差要10s+才能加载出页面) 根前缀指定 (用户可选..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":6.17,"words":1852},"filePathRelative":"01. DesignAndDevelop/Develop/04. Project/Type/Doc/MarkdwonAbout/01. Soft And Frame/VuePress2 (Vue3)/03. 主题扩展/Hope主题/09. Private/02. 个人魔改.md","excerpt":"\\n<h2>魔改内容</h2>\\n<h3>总结</h3>\\n<h4>需要修改的内容</h4>\\n<ul>\\n<li>侧边栏部分，文件夹化 (主要得修改主题源码)\\n<ul>\\n<li>✅ 点击另一处不自动折叠</li>\\n<li>✅ 目录名（任何时候都应当以文件名为主，而非h1的名字，<a href=\\"http://xn--README-9q7jz15exrm.md\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">哪怕是README.md</a>）<br>\\n同时解决无h1时会产生bug的问题</li>\\n<li>使用懒加载，否则当路径上千时，打开页面贼慢 (可能较难，但不弄的话网差要10s+才能加载出页面)</li>\\n<li>根前缀指定 (用户可选择某个路径作为根路径，以指定的新的根路径而非绝对的根路径，重新显示侧边栏)</li>\\n<li>收缩再展开时保留原来的折叠状态</li>\\n<li>样式调整：展开箭头前置及优化</li>\\n</ul>\\n</li>\\n<li>TOC部分\\n<ul>\\n<li>✅ toc级别（默认配置，只到3级，应该全开）</li>\\n<li>toc的缩进与可折叠（只靠css和少量源码修改应该就能实现）</li>\\n</ul>\\n</li>\\n<li>正文\\n<ul>\\n<li>标题及列表的点击展开收缩</li>\\n<li>重写 ob 的 AnyBlock 插件</li>\\n<li>✅ 窄屏改宽屏</li>\\n</ul>\\n</li>\\n<li>通用样式类\\n<ul>\\n<li>✅ 层级着色（正文标题 + 目录大纲 + TOC大纲 + 路径导航）</li>\\n</ul>\\n</li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"01. DesignAndDevelop/Develop/04. Project/Type/Doc/MarkdwonAbout/01. Soft And Frame/VuePress2 (Vue3)/03. 主题扩展/Hope主题/09. Private/02. 个人魔改.md","value":{"title":"02. 个人魔改","path":"01. DesignAndDevelop/Develop/04. Project/Type/Doc/MarkdwonAbout/01. Soft And Frame/VuePress2 (Vue3)/03. 主题扩展/Hope主题/09. Private/02. 个人魔改.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{d as comp,o as data};
