...
`},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          if (is_all_fold=="true") {
            ...
            const btn_subs = table.querySelectorAll("tr[is_fold='false']>td:first-child");
              btn_subs.forEach((btn_sub) => { btn_sub.click() }) // 注意setAttr版本无断言
          }`},[t("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-fold-vertical-icon lucide-fold-vertical"},[t("path",{d:"M12 22v-6"}),t("path",{d:"M12 8V2"}),t("path",{d:"M4 12H2"}),t("path",{d:"M10 12H8"}),t("path",{d:"M16 12h-2"}),t("path",{d:"M22 12h-2"}),t("path",{d:"m15 19-3-3-3 3"}),t("path",{d:"m15 5-3 3-3-3"})])])])],-1),t("h2",{id:"其他",tabindex:"-1"},"其他",-1),t("p",null,"目前看到这里应该会是挺懵逼的，需要后面详细举例和分别描述，才能有所体会。",-1),t("p",null,"下面，让我们一一来学习这些概念以及如何在实践中运用。",-1)])])}const _=s(a,[["render",d]]),b=JSON.parse('{"path":"/01.%20DesignAndDevelop/Develop/01.%20Language/Rust/%E5%AD%A6%E4%B9%A0/07.%20%E6%A8%A1%E5%9D%97%E5%BA%93/","title":"包和模块","lang":"zh-CN","frontmatter":{"description":"包和模块 为什么需要包，封装多个文件/模块 当工程规模变大时，把代码写到一个甚至几个文件中，都是不太聪明的做法，可能存在以下问题： 单个文件过大，导致打开、翻页速度大幅变慢 查询和定位效率大幅降低，类比下，你会把所有知识内容放在一个几十万字的文档中吗？ 只有一个代码层次：函数，难以维护和协作，想象一下你的操作系统只有一个根目录，剩下的都是单层子目录会如...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"包和模块\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/01.%20Language/Rust/%E5%AD%A6%E4%B9%A0/07.%20%E6%A8%A1%E5%9D%97%E5%BA%93/"}],["meta",{"property":"og:site_name","content":"MdNote_Public"}],["meta",{"property":"og:title","content":"包和模块"}],["meta",{"property":"og:description","content":"包和模块 为什么需要包，封装多个文件/模块 当工程规模变大时，把代码写到一个甚至几个文件中，都是不太聪明的做法，可能存在以下问题： 单个文件过大，导致打开、翻页速度大幅变慢 查询和定位效率大幅降低，类比下，你会把所有知识内容放在一个几十万字的文档中吗？ 只有一个代码层次：函数，难以维护和协作，想象一下你的操作系统只有一个根目录，剩下的都是单层子目录会如..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":3.24,"words":971},"filePathRelative":"01. DesignAndDevelop/Develop/01. Language/Rust/学习/07. 模块库/README.md","excerpt":"\\n<h2>为什么需要包，封装多个文件/模块</h2>\\n<p>当工程规模变大时，把代码写到一个甚至几个文件中，都是不太聪明的做法，可能存在以下问题：</p>\\n<ol>\\n<li>单个文件过大，导致打开、翻页速度大幅变慢</li>\\n<li>查询和定位效率大幅降低，类比下，你会把所有知识内容放在一个几十万字的文档中吗？</li>\\n<li>只有一个代码层次：函数，难以维护和协作，想象一下你的操作系统只有一个根目录，剩下的都是单层子目录会如何：<code>disaster</code></li>\\n<li>容易滋生 Bug</li>\\n</ol>\\n<p>同时，将大的代码文件拆分成包和模块，还允许我们实现代码抽象和复用：将你的代码封装好后提供给用户，那么用户只需要调用公共接口即可，无需知道内部该如何实现。</p>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"01. DesignAndDevelop/Develop/01. Language/Rust/学习/07. 模块库/README.md","value":{"title":"学习/","path":"01. DesignAndDevelop/Develop/01. Language/Rust/学习/07. 模块库/README.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{_ as comp,b as data};
