import{_ as r,c as n,e,a as t,o as s}from"./app-CJvEMtK0.js";const o={};function i(a,l){return s(),n("div",null,l[0]||(l[0]=[e('<h1 id="goldenlayout" tabindex="-1"><a class="header-anchor" href="#goldenlayout"><span>GoldenLayout</span></a></h1><p>这个我23年用过，挺好用的。现在25年又需要用，再了下，也到v2版本了。顺便在用的时候做做笔记</p><p>不过就是两年没更新</p><ul><li>参考 <ul><li>repo: https://github.com/golden-layout/golden-layout</li><li>website: https://golden-layout.github.io/golden-layout/</li><li>oldWebsite (v1): http://golden-layout.com/</li><li>demo online: https://codepen.io/pbklink/pen/dyWJNNm</li></ul></li></ul><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><div class="language-shell line-numbers-mode" data-highlighter="shiki" data-ext="shell" data-title="shell" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">npm</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> i</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> golden-layout</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="使用" tabindex="-1"><a class="header-anchor" href="#使用"><span>使用</span></a></h2><p>主要还是使用v1文档的demo和docs，v2的说明很少的</p><h2 id="v1文档" tabindex="-1"><a class="header-anchor" href="#v1文档"><span>V1文档</span></a></h2>',9),t("div",{class:"ab-note drop-shadow"},[t("table",{class:"ab-table ab-list-table"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"false",type:"Download   ",onclick:`
         const tr = this
