import{_ as e,c as n,e as t,o as l}from"./app-Dt9PEj-q.js";const a={};function s(r,i){return l(),n("div",null,i[0]||(i[0]=[t(`<h1 id="c" tabindex="-1"><a class="header-anchor" href="#c"><span>C++</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="一致性初始化-列表初始化-uniform-initialization-initializer-lists" tabindex="-1"><a class="header-anchor" href="#一致性初始化-列表初始化-uniform-initialization-initializer-lists"><span>一致性初始化/列表初始化 Uniform Initialization/Initializer Lists</span></a></h1><h2 id="基本用法" tabindex="-1"><a class="header-anchor" href="#基本用法"><span>基本用法</span></a></h2><h3 id="旧写法" tabindex="-1"><a class="header-anchor" href="#旧写法"><span>旧写法</span></a></h3><blockquote><p>Before C++11, programmers, especially novices, could easily become confused by the question ofhow to initialize a variable or an object. Initialization could happen with parentheses, braces, and/orassignment operators.</p></blockquote><p>即以前的代码初始化写法很多</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>Rect r1 = {3, 7, 20, 25, &amp;area, &amp;print};	// 等号、大括号
