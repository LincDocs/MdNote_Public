import{_ as i,c as n,e as s,o as l}from"./app-nyIV-ksP.js";const d={};function a(t,e){return l(),n("div",null,e[0]||(e[0]=[s(`<h1 id="mysql" tabindex="-1"><a class="header-anchor" href="#mysql"><span>MySQL</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="sql命令" tabindex="-1"><a class="header-anchor" href="#sql命令"><span>SQL命令</span></a></h1><h2 id="use-使用数据库" tabindex="-1"><a class="header-anchor" href="#use-使用数据库"><span>USE（使用数据库）</span></a></h2><div class="language-mysql line-numbers-mode" data-ext="mysql" data-title="mysql"><pre class="language-mysql"><code>-- SQL不分大小写，一般&#39;命令&#39;大写其他小写
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,23)]))}const c=i(d,[["render",a],["__file","02. SQL命令.html.vue"]]),v=JSON.parse(`{"path":"/01.%20DesignAndDevelop/Develop/04.%20Project/Platform/Web/04.%20%E5%90%8E%E7%AB%AF/%E6%95%B0%E6%8D%AE%E5%BA%93/02.%20MySQL/Mosh%20Hamedani/02.%20SQL%E5%91%BD%E4%BB%A4.html","title":"MySQL","lang":"zh-CN","frontmatter":{"description":"MySQL 目录 SQL命令 USE（使用数据库） SELECT（选择列）及其子句 一些子句：WHERE（条件筛选），ORDER BY（排序），LIMIT（限制） JOIN（连接）（连接字段与字段） UNION（联合）（连接记录与记录） INSERT（插入） UPDATE（更新，更改值） DELETE（删除） CREARE（创建表） PROJECT","head":[["meta",{"property":"og:url","content":"https://LincDocs.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/04.%20Project/Platform/Web/04.%20%E5%90%8E%E7%AB%AF/%E6%95%B0%E6%8D%AE%E5%BA%93/02.%20MySQL/Mosh%20Hamedani/02.%20SQL%E5%91%BD%E4%BB%A4.html"}],["meta",{"property":"og:site_name","content":"MdNote_Public"}],["meta",{"property":"og:title","content":"MySQL"}],["meta",{"property":"og:description","content":"MySQL 目录 SQL命令 USE（使用数据库） SELECT（选择列）及其子句 一些子句：WHERE（条件筛选），ORDER BY（排序），LIMIT（限制） JOIN（连接）（连接字段与字段） UNION（联合）（连接记录与记录） INSERT（插入） UPDATE（更新，更改值） DELETE（删除） CREARE（创建表） PROJECT"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-01-22T04:20:37.000Z"}],["meta",{"property":"article:author","content":"LincDocs"}],["meta",{"property":"article:modified_time","content":"2025-01-22T04:20:37.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"MySQL\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-01-22T04:20:37.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincDocs\\",\\"url\\":\\"https://github.com/LincDocs/MdNote_Public/\\"}]}"]]},"headers":[{"level":1,"title":"MySQL","slug":"mysql","link":"#mysql","children":[]},{"level":1,"title":"目录","slug":"目录","link":"#目录","children":[]},{"level":1,"title":"SQL命令","slug":"sql命令","link":"#sql命令","children":[{"level":2,"title":"USE（使用数据库）","slug":"use-使用数据库","link":"#use-使用数据库","children":[]},{"level":2,"title":"SELECT（选择列）及其子句","slug":"select-选择列-及其子句","link":"#select-选择列-及其子句","children":[]},{"level":2,"title":"一些子句：WHERE（条件筛选），ORDER BY（排序），LIMIT（限制）","slug":"一些子句-where-条件筛选-order-by-排序-limit-限制","link":"#一些子句-where-条件筛选-order-by-排序-limit-限制","children":[]},{"level":2,"title":"JOIN（连接）（连接字段与字段）","slug":"join-连接-连接字段与字段","link":"#join-连接-连接字段与字段","children":[]},{"level":2,"title":"UNION（联合）（连接记录与记录）","slug":"union-联合-连接记录与记录","link":"#union-联合-连接记录与记录","children":[]},{"level":2,"title":"INSERT（插入）","slug":"insert-插入","link":"#insert-插入","children":[]},{"level":2,"title":"UPDATE（更新，更改值）","slug":"update-更新-更改值","link":"#update-更新-更改值","children":[]},{"level":2,"title":"DELETE（删除）","slug":"delete-删除","link":"#delete-删除","children":[]},{"level":2,"title":"CREARE（创建表）","slug":"creare-创建表","link":"#creare-创建表","children":[]},{"level":2,"title":"PROJECT","slug":"project","link":"#project","children":[]}]}],"git":{"createdTime":1737519637000,"updatedTime":1737519637000,"contributors":[{"name":"Linc","email":"762699299@qq.com","commits":1}]},"readingTime":{"minutes":3.09,"words":926},"filePathRelative":"01. DesignAndDevelop/Develop/04. Project/Platform/Web/04. 后端/数据库/02. MySQL/Mosh Hamedani/02. SQL命令.md","localizedDate":"2025年1月22日","excerpt":"\\n<h1>目录</h1>\\n<h1>SQL命令</h1>\\n<h2>USE（使用数据库）</h2>\\n<div class=\\"language-mysql\\" data-ext=\\"mysql\\" data-title=\\"mysql\\"><pre class=\\"language-mysql\\"><code>-- SQL不分大小写，一般'命令'大写其他小写\\nUSE sql_store;  -- 数据库，若只有一个数据库或在指定数据库下运行则可省略\\n</code></pre></div><h2>SELECT（选择列）及其子句</h2>\\n<div class=\\"language-mysql\\" data-ext=\\"mysql\\" data-title=\\"mysql\\"><pre class=\\"language-mysql\\"><code>--标准示例\\nSELECT customer_id, last_name\\nFROM customers  \\t\\t\\t\\t\\t-- 从表选择\\nWHERE customer_id = 1  \\t\\t\\t\\t-- 筛选。布尔：()&gt;NOT&gt;AND&gt;OR\\nORDER BY first_name  \\t\\t\\t\\t-- 按某列排序\\nLIMIT 10  \\t\\t\\t\\t\\t\\t\\t-- 仅显示前10条数据\\n \\n--SELECT子句扩展（选择）\\nSELECT points + 10 AS points_factor\\t-- 可输入表达式，若列名有空格可加引号\\nSELECT DISTINCT state  \\t\\t\\t\\t-- 获得唯一值列表\\n</code></pre></div>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"01. DesignAndDevelop/Develop/04. Project/Platform/Web/04. 后端/数据库/02. MySQL/Mosh Hamedani/02. SQL命令.md","value":{"title":"02. SQL命令","path":"01. DesignAndDevelop/Develop/04. Project/Platform/Web/04. 后端/数据库/02. MySQL/Mosh Hamedani/02. SQL命令.md","outlink":[],"backlink":[]}}],"links":[]}}}`);export{c as comp,v as data};
