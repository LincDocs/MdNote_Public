import{_ as l,c as n,e as i,o as t}from"./app-Dt9PEj-q.js";const a={};function d(s,e){return t(),n("div",null,e[0]||(e[0]=[i(`<h1 id="dll-compiled-by-all-language" tabindex="-1"><a class="header-anchor" href="#dll-compiled-by-all-language"><span>DLL Compiled By All Language</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="vs-cpp-dll-use" tabindex="-1"><a class="header-anchor" href="#vs-cpp-dll-use"><span>VS_Cpp_Dll_Use</span></a></h1><h2 id="项目配置方法" tabindex="-1"><a class="header-anchor" href="#项目配置方法"><span>项目配置方法</span></a></h2><h3 id="工程模板" tabindex="-1"><a class="header-anchor" href="#工程模板"><span>工程模板</span></a></h3><p>ConsoleApplication1.cpp</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>// ConsoleApplication1.cpp : 此文件包含 &quot;main&quot; 函数。程序执行将在此处开始并结束。
//
