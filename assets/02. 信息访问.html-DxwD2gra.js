import{_ as n,e as a,j as i,o as e}from"./app-CKcrM0IQ.js";const l="/MdNote_Public/assets/4%E7%A7%8D%E6%95%B0-rrUYbnsl.png",p={};function d(t,s){return e(),a("div",null,s[0]||(s[0]=[i('<h1 id="computersystems" tabindex="-1"><a class="header-anchor" href="#computersystems"><span>ComputerSystems</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="信息访问" tabindex="-1"><a class="header-anchor" href="#信息访问"><span>信息访问</span></a></h1><h2 id="mov-数据传送指令" tabindex="-1"><a class="header-anchor" href="#mov-数据传送指令"><span>mov（数据传送指令）</span></a></h2><p>把不同的指令划分成<code>指令类</code>（每一类指令都执行相同的操作，主要区别在与操作数大小不同）</p><p>（表格中“效果”一列的前者是<code>源操作数</code>，后者是<code>目的操作数</code>）</p><h3 id="mov" tabindex="-1"><a class="header-anchor" href="#mov"><span>mov</span></a></h3><h4 id="存储单元之间的数据传输关系-mov" tabindex="-1"><a class="header-anchor" href="#存储单元之间的数据传输关系-mov"><span>存储单元之间的数据传输关系（mov）</span></a></h4><p>mov 目的操作数, 源操作数 # 位宽必须一致</p><p>操作对象有4种</p><ul><li>通用寄存器：AX、BX等</li><li>段寄存器：CS、DS等</li><li>内存单元</li><li>立即数、常数</li></ul><p><img src="'+l+`" alt="image-20211110001421862" loading="lazy"></p><h4 id="实战demo" tabindex="-1"><a class="header-anchor" href="#实战demo"><span>实战demo</span></a></h4><p>mov.asm</p><div class="language-assembly line-numbers-mode" data-highlighter="shiki" data-ext="assembly" data-title="assembly" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span># 立即数相关</span></span>
