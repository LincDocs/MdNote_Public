import{_ as d,c as o,a as s,d as t,e as B,w as a,r as p,o as r,b as i}from"./app-DMf6WVf4.js";const A={};function g(c,n){const h=p("VueFlow"),k=p("Tabs");return r(),o("div",null,[n[6]||(n[6]=s("h1",{id:"nodeflow-列表语法",tabindex:"-1"},"NodeFlow 列表语法",-1)),n[7]||(n[7]=s("h2",{id:"一种基于markdown列表的便于输入的节点描述语法",tabindex:"-1"},"一种基于Markdown列表的便于输入的节点描述语法",-1)),n[8]||(n[8]=s("p",null,"新增一种能手写的格式，说真的有时设计语法比开发成就感还强……大家讨论讨论语法，看有没有什么可以优化的地方",-1)),n[9]||(n[9]=s("ol",null,[s("li",null,"该语法可以和AnyBlock插件配合，从列表进行声明"),s("li",null,"参考了：JSON、JSONL、YAML、Mermaid/Mehrmaid 流程图语法")],-1)),n[10]||(n[10]=s("h3",{id:"示例",tabindex:"-1"},"示例",-1)),t(k,{id:"24",data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:a(({value:e,isActive:l})=>n[0]||(n[0]=[i("Plugin effect (插件效果)")])),title1:a(({value:e,isActive:l})=>n[1]||(n[1]=[i("md source code (md源码)")])),tab0:a(({value:e,isActive:l})=>[t(h,{type:"nodeflow-list",data:`- nodes
  - node1: KSample
    - Latent, o
    - model, i
    - positive, i
...
`})]),tab1:a(({value:e,isActive:l})=>n[2]||(n[2]=[s("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[s("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[s("code",{class:"language-md"},[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```nodeflow-list")]),i(`
...
- edges
  ...
  - node2,o, node3,i
  - node2,o, node4,b
`})]),tab1:a(({value:e,isActive:l})=>n[5]||(n[5]=[s("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[s("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[s("code",{class:"language-md"},[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```nodeflow-list")]),i(`
`),s("span",{class:"line"}),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"- nodes")]),i(`
