import{_ as i,c as n,e as s,o as l}from"./app-Z3IVicAk.js";const d={};function a(t,e){return l(),n("div",null,e[0]||(e[0]=[s(`<h1 id="mysql" tabindex="-1"><a class="header-anchor" href="#mysql"><span>MySQL</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="sql命令" tabindex="-1"><a class="header-anchor" href="#sql命令"><span>SQL命令</span></a></h1><h2 id="use-使用数据库" tabindex="-1"><a class="header-anchor" href="#use-使用数据库"><span>USE（使用数据库）</span></a></h2><div class="language-mysql line-numbers-mode" data-ext="mysql" data-title="mysql"><pre class="language-mysql"><code>-- SQL不分大小写，一般&#39;命令&#39;大写其他小写
