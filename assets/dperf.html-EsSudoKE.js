import{_ as t,c as p,e as l,a as s,b as a,d as i,o as c,r as d}from"./app-D56eNcZZ.js";const r={},o={href:"https://github.com/baidu/dperf",target:"_blank",rel:"noopener noreferrer"},m={href:"https://dperf.org/",target:"_blank",rel:"noopener noreferrer"},u={href:"https://dperf.org/doc/html/configuration",target:"_blank",rel:"noopener noreferrer"};function v(b,n){const e=d("ExternalLinkIcon");return c(),p("div",null,[n[7]||(n[7]=l(`<h2 id="dpdk环境部分-不建议先单独安装dpdk-而是按dperf的说明安装dpdk" tabindex="-1"><a class="header-anchor" href="#dpdk环境部分-不建议先单独安装dpdk-而是按dperf的说明安装dpdk"><span>DPDK环境部分 (不建议先单独安装DPDK，而是按DPerf的说明安装DPDK)</span></a></h2><h3 id="参考" tabindex="-1"><a class="header-anchor" href="#参考"><span>参考</span></a></h3><ul><li>官网：https://www.dpdk.org/</li><li>下载：http://core.dpdk.org/download/</li><li>安装：http://core.dpdk.org/doc/quick-start/</li><li>文档：https://doc.dpdk.org/guides/linux_gsg/index.html</li></ul><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">tar</span> xf dpdk.tar.gz
