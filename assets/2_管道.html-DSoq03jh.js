...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="defer-recover-机制处理错误" tabindex="-1"><a class="header-anchor" href="#defer-recover-机制处理错误"><span>defer + recover 机制处理错误</span></a></h4><p>背景：多个协程工作，避免 其中一个协程出现panic 导致程序崩溃</p><p>案例：就正常写。协程函数里加个 <code>defer func(){ err:= recover; if err != nil {...}}</code> 就行了</p>`,37)]))}const o=s(p,[["render",i],["__file","2_管道.html.vue"]]),u=JSON.parse('{"path":"/01.%20DesignAndDevelop/Develop/01.%20Language/Go/09_%E5%8A%9F%E8%83%BD%E5%AE%9E%E7%8E%B0%E7%B1%BB/%E8%BF%9B%E7%A8%8B%20%E7%BA%BF%E7%A8%8B%20%E5%8D%8F%E7%A8%8B/2_%E7%AE%A1%E9%81%93.html","title":"管道","lang":"zh-CN","frontmatter":{"description":"管道 （先读协程内容先） 管道 (channel) 概括 特性介绍： 本质 本质是一个数据结构：队列 (先进先出) 有类型，例如一个string只能存放string类型数据 自身线程安全，多协程访问时无需加锁，本身线程安全。与协程关系密切 用处 可作为流式IO。类似 C++ 的std::cout流那种感觉 线程安全，故可和协程配合使用 声明定义、使用 ...","head":[["meta",{"property":"og:url","content":"https://LincDocs.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/01.%20Language/Go/09_%E5%8A%9F%E8%83%BD%E5%AE%9E%E7%8E%B0%E7%B1%BB/%E8%BF%9B%E7%A8%8B%20%E7%BA%BF%E7%A8%8B%20%E5%8D%8F%E7%A8%8B/2_%E7%AE%A1%E9%81%93.html"}],["meta",{"property":"og:site_name","content":"MdNote_Public"}],["meta",{"property":"og:title","content":"管道"}],["meta",{"property":"og:description","content":"管道 （先读协程内容先） 管道 (channel) 概括 特性介绍： 本质 本质是一个数据结构：队列 (先进先出) 有类型，例如一个string只能存放string类型数据 自身线程安全，多协程访问时无需加锁，本身线程安全。与协程关系密切 用处 可作为流式IO。类似 C++ 的std::cout流那种感觉 线程安全，故可和协程配合使用 声明定义、使用 ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-01-19T07:08:37.000Z"}],["meta",{"property":"article:author","content":"LincDocs"}],["meta",{"property":"article:modified_time","content":"2025-01-19T07:08:37.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"管道\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-01-19T07:08:37.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincDocs\\",\\"url\\":\\"https://github.com/LincDocs/MdNote_Public/\\"}]}"]]},"headers":[{"level":1,"title":"管道","slug":"管道","link":"#管道","children":[{"level":2,"title":"管道 (channel)","slug":"管道-channel","link":"#管道-channel","children":[{"level":3,"title":"概括","slug":"概括","link":"#概括","children":[]},{"level":3,"title":"声明定义、使用","slug":"声明定义、使用","link":"#声明定义、使用","children":[]},{"level":3,"title":"方法","slug":"方法","link":"#方法","children":[{"level":4,"title":"关闭管道","slug":"关闭管道","link":"#关闭管道","children":[]},{"level":4,"title":"遍历","slug":"遍历","link":"#遍历","children":[]}]},{"level":3,"title":"扩展","slug":"扩展","link":"#扩展","children":[{"level":4,"title":"(实战) 协程和管道 协同工作","slug":"实战-协程和管道-协同工作","link":"#实战-协程和管道-协同工作","children":[]},{"level":4,"title":"只读/只写管道","slug":"只读-只写管道","link":"#只读-只写管道","children":[]},{"level":4,"title":"管道的阻塞","slug":"管道的阻塞","link":"#管道的阻塞","children":[]},{"level":4,"title":"select case 语法","slug":"select-case-语法","link":"#select-case-语法","children":[]},{"level":4,"title":"defer + recover 机制处理错误","slug":"defer-recover-机制处理错误","link":"#defer-recover-机制处理错误","children":[]}]}]}]}],"git":{"createdTime":1737270517000,"updatedTime":1737270517000,"contributors":[{"name":"Linc","email":"762699299@qq.com","commits":1}]},"readingTime":{"minutes":3.34,"words":1001},"filePathRelative":"01. DesignAndDevelop/Develop/01. Language/Go/09_功能实现类/进程 线程 协程/2_管道.md","localizedDate":"2025年1月19日","excerpt":"\\n<p>（先读协程内容先）</p>\\n<h2>管道 (channel)</h2>\\n<h3>概括</h3>\\n<p>特性介绍：</p>\\n<ul>\\n<li>\\n<p>本质</p>\\n<ul>\\n<li>\\n<p>本质是一个数据结构：队列 (先进先出)</p>\\n</li>\\n<li>\\n<p>有类型，例如一个string只能存放string类型数据</p>\\n</li>\\n<li>\\n<p>自身线程安全，多协程访问时无需加锁，本身线程安全。与协程关系密切</p>\\n</li>\\n</ul>\\n</li>\\n<li>\\n<p>用处</p>\\n<ul>\\n<li>可作为流式IO。类似 C++ 的std::cout流那种感觉</li>\\n<li>线程安全，故可和协程配合使用</li>\\n</ul>\\n</li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"01. DesignAndDevelop/Develop/01. Language/Go/09_功能实现类/进程 线程 协程/2_管道.md","value":{"title":"2_管道","path":"01. DesignAndDevelop/Develop/01. Language/Go/09_功能实现类/进程 线程 协程/2_管道.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{o as comp,u as data};
