import{_ as o,c as i,e as r,a as t,b as n,d as a,f as l,o as d,r as p}from"./app-D56eNcZZ.js";const c={},u={href:"https://blacksmithgu.github.io/obsidian-dataview/api/intro/",target:"_blank",rel:"noopener noreferrer"},f={href:"https://quickadd.obsidian.guide/docs/Choices/MacroChoice",target:"_blank",rel:"noopener noreferrer"},_={href:"https://github.com/LincDemo/obsidian-api-request/tree/master",target:"_blank",rel:"noopener noreferrer"};function b(v,e){const s=p("ExternalLinkIcon");return d(),i("div",null,[e[14]||(e[14]=r('<h1 id="插件间通信" tabindex="-1"><a class="header-anchor" href="#插件间通信"><span>插件间通信</span></a></h1><h2 id="可供参考的插件-文档" tabindex="-1"><a class="header-anchor" href="#可供参考的插件-文档"><span>可供参考的插件/文档</span></a></h2><p>这里对之前调研的方式做一些归纳，以及补充</p><p>提前总结：</p><p>（结合我接下来要做的一个东西的选型，他们各自都有一些缺点）</p><ul><li>事件注册方式、渲染驱动方式：拿不到返回值</li><li>全局状态方式：不够灵活，能分享的内容有限</li><li>http方式、app.plugins.plugins方式：需要对方插件的配合</li></ul><h3 id="http方式" tabindex="-1"><a class="header-anchor" href="#http方式"><span>Http方式</span></a></h3><p>这里有两个可供参考的插件：</p><ul><li>Local Rest API</li><li>APIRequest</li></ul><p>这两个插件我会在后面进行剖析、原理分析</p><h3 id="事件注册方式" tabindex="-1"><a class="header-anchor" href="#事件注册方式"><span>事件注册方式</span></a></h3><p>注册命令</p><h3 id="渲染驱动" tabindex="-1"><a class="header-anchor" href="#渲染驱动"><span>渲染驱动</span></a></h3><p><code>MarkdownRender()</code> 方法</p><p>可以参考 https://any-block.github.io/obsidian-any-block/docs/zh/05.%20%E7%B2%BE%E5%BD%A9%E7%94%A8%E4%BE%8B.html 里的一些例子</p><h3 id="全局状态方式" tabindex="-1"><a class="header-anchor" href="#全局状态方式"><span>全局状态方式</span></a></h3><p>暂时不研究，因为不打算使用这种方式。</p><p>全局状态一般只适合分享一些比较小且固定、预定好的几个状态变量，不满足我的当前需求。</p><h3 id="app-plugins-plugins-获取其他插件实例" tabindex="-1"><a class="header-anchor" href="#app-plugins-plugins-获取其他插件实例"><span>app.plugins.plugins 获取其他插件实例</span></a></h3><h4 id="各插件提供的api" tabindex="-1"><a class="header-anchor" href="#各插件提供的api"><span>各插件提供的API</span></a></h4><p>参考：obsidian 群的 Moy 群友</p>',21)),t("ul",null,[e[8]||(e[8]=t("li",null,[n("Templater： "),t("code",null,'app.plugins.plugins["templater-obsidian"].templater.current_functions_object')],-1)),e[9]||(e[9]=t("li",null,[n("TP 中调用 Obsidian 的 API： "),t("code",null,"tp.obsidian")],-1)),t("li",null,[t("a",u,[e[0]||(e[0]=n("Dataview")),a(s)]),e[1]||(e[1]=n("： ")),e[2]||(e[2]=t("code",null,"app.plugins.plugins.dataview.api",-1))]),e[10]||(e[10]=t("li",null,[n("QuickAdd： "),t("code",null,"this.quickAddApi")],-1)),t("li",null,[e[4]||(e[4]=n("Metaedit： ")),e[5]||(e[5]=t("code",null,'app.plugins.plugins["metaedit"].api',-1)),e[6]||(e[6]=n(" （来自 QuickAdd 的")),t("a",f,[e[3]||(e[3]=n("文档")),a(s)]),e[7]||(e[7]=n("）"))])]),e[15]||(e[15]=r(`<h4 id="注册api" tabindex="-1"><a class="header-anchor" href="#注册api"><span>注册api</span></a></h4><p>那么这些插件是如何注册api的呢？</p><p>见后面dataview的分析</p><h2 id="参考插件深入剖析" tabindex="-1"><a class="header-anchor" href="#参考插件深入剖析"><span>参考插件深入剖析</span></a></h2><h3 id="dataview-原理分析" tabindex="-1"><a class="header-anchor" href="#dataview-原理分析"><span>dataview - 原理分析</span></a></h3><p>参考: https://github.com/blacksmithgu/obsidian-dataview/blob/6d9030ef1df9c3f310f42e3502149dc71792dc4d/src/main.ts#L59</p><div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">class</span> <span class="token class-name">DataviewPlugin</span> <span class="token keyword">extends</span> <span class="token class-name">Plugin</span> <span class="token punctuation">{</span>
  <span class="token keyword">public</span> api<span class="token operator">:</span> DataviewApi<span class="token punctuation">;</span>
   <span class="token keyword">async</span> <span class="token function">onload</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// From this point onwards the dataview API is fully functional (even if the index needs to do some background indexing).</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>api <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">DataviewApi</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>app<span class="token punctuation">,</span> <span class="token keyword">this</span><span class="token punctuation">.</span>index<span class="token punctuation">,</span> <span class="token keyword">this</span><span class="token punctuation">.</span>settings<span class="token punctuation">,</span> <span class="token keyword">this</span><span class="token punctuation">.</span>manifest<span class="token punctuation">.</span>version<span class="token punctuation">)</span><span class="token punctuation">;</span>
    
    <span class="token comment">// Register API to global window object.</span>
    <span class="token punctuation">(</span>window<span class="token punctuation">[</span><span class="token string">&quot;DataviewAPI&quot;</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>api<span class="token punctuation">)</span> <span class="token operator">&amp;&amp;</span> <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">register</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token keyword">delete</span> window<span class="token punctuation">[</span><span class="token string">&quot;DataviewAPI&quot;</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="local-rest-api-插件" tabindex="-1"><a class="header-anchor" href="#local-rest-api-插件"><span>Local Rest API - 插件</span></a></h3><ul><li>接收外部的http请求，以执行一些操作。可用于自动化</li><li>github: https://github.com/coddingtonbear/obsidian-local-rest-api star 712</li><li>其文档: https://coddingtonbear.github.io/obsidian-local-rest-api/</li></ul><h3 id="local-rest-api-原理分析" tabindex="-1"><a class="header-anchor" href="#local-rest-api-原理分析"><span>Local Rest API - 原理分析</span></a></h3><ul><li></li></ul><h3 id="apirequest-插件" tabindex="-1"><a class="header-anchor" href="#apirequest-插件"><span>APIRequest - 插件</span></a></h3><ul><li>发送http请求到外部，并获取响应值</li><li>官网 <ul><li>github: https://github.com/Rooyca/obsidian-api-request star 126</li><li>文档: https://rooyca.github.io/obsidian-api-request/</li></ul></li><li>我的fork (中文注释) <ul><li>github: https://github.dev/LincDemo/obsidian-api-request</li><li>文档: https://lincdocs.github.io/obsidian-api-request/</li></ul></li></ul><h3 id="apirequest-原理分析" tabindex="-1"><a class="header-anchor" href="#apirequest-原理分析"><span>APIRequest - 原理分析</span></a></h3>`,14)),t("p",null,[e[12]||(e[12]=n("（部分在 ")),t("a",_,[e[11]||(e[11]=n("注释fork")),a(s)]),e[13]||(e[13]=n(" 中）"))]),e[16]||(e[16]=t("div",{class:"ab-note drop-shadow"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"false",type:"folder",onclick:`
          const tr = this
...
`,onclick:`
          ...
          if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
        `},[t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[l("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,"README.zh.md")])])])])]),t("button",{class:"ab-table-fold",is_fold:"false"},"全部折叠/展开")])],-1)),e[17]||(e[17]=r(`<p>依赖 (package.json)，并没有使用什么特别的库</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token property">&quot;devDependencies&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
