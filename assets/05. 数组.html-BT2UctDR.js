import{_ as n,c as i,e as t,o as s}from"./app-Z3IVicAk.js";const l={};function d(a,e){return s(),i("div",null,e[0]||(e[0]=[t(`<h1 id="computersystems" tabindex="-1"><a class="header-anchor" href="#computersystems"><span>ComputerSystems</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="数组" tabindex="-1"><a class="header-anchor" href="#数组"><span>数组</span></a></h1><h2 id="字符串" tabindex="-1"><a class="header-anchor" href="#字符串"><span>字符串</span></a></h2><h2 id="如何更优雅的打印字符串" tabindex="-1"><a class="header-anchor" href="#如何更优雅的打印字符串"><span>如何更优雅的打印字符串</span></a></h2><p>需求：给定一段字符串，打印出来</p><p>方法：</p><p>数据源：ds (数据段寄存器) + si (源索引寄存器)，每取出一个字符si就+1 输出：es (扩展段寄存器) + di (目标索引寄存器)，其中es保存显存的地址 = 0xb800，每写入一个自负di就+1 通过循环依次取字符和输出字符 中续：BL待写入，BH字符属性</p><div class="language-assembly line-numbers-mode" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code>section code align=16 vstart=0x7c00
