import{_ as h,c as k,a as i,d as t,e as c,w as l,r,o as p,b as s}from"./app-1eSa63Y2.js";const B={};function u(m,n){const d=r("VueFlow"),o=r("Tabs");return p(),k("div",null,[n[6]||(n[6]=i("h1",{id:"nodeflow-列表语法",tabindex:"-1"},"NodeFlow 列表语法",-1)),n[7]||(n[7]=i("h2",{id:"介绍-一种基于markdown列表的便于输入的节点描述语法",tabindex:"-1"},"介绍，一种基于Markdown列表的便于输入的节点描述语法",-1)),n[8]||(n[8]=i("p",null,"新增一种能手写的格式，说真的有时设计语法比开发成就感还强……大家讨论讨论语法，看有没有什么可以优化的地方",-1)),n[9]||(n[9]=i("ol",null,[i("li",null,"该语法可以和AnyBlock插件配合，从列表进行声明"),i("li",null,"参考了：JSON、JSONL、YAML、Mermaid/Mehrmaid 流程图语法")],-1)),n[10]||(n[10]=i("h2",{id:"示例",tabindex:"-1"},"示例",-1)),n[11]||(n[11]=i("h3",{id:"语法示例",tabindex:"-1"},"语法示例",-1)),t(o,{id:"27",data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:l(({value:e,isActive:a})=>n[0]||(n[0]=[s("Plugin effect (插件效果)")])),title1:l(({value:e,isActive:a})=>n[1]||(n[1]=[s("md source code (md源码)")])),tab0:l(({value:e,isActive:a})=>[t(d,{type:"nodeflow-list",data:`- nodes
  - NodeTitle
    - only name, i
    - i2, i, *i2
    - i3, i, mul line
    ...
    - v5:, , only value
      ...
      v5-2
- edges
`})]),tab1:l(({value:e,isActive:a})=>n[2]||(n[2]=[i("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md","data-title":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[i("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```nodeflow-list")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```")])])]),i("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"})])],-1)])),_:1}),n[12]||(n[12]=i("h3",{id:"实际用例",tabindex:"-1"},"实际用例",-1)),t(o,{id:"38",data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:l(({value:e,isActive:a})=>n[3]||(n[3]=[s("Plugin effect (插件效果)")])),title1:l(({value:e,isActive:a})=>n[4]||(n[4]=[s("md source code (md源码)")])),tab0:l(({value:e,isActive:a})=>[t(d,{type:"nodeflow-list",data:`- nodes
  - node1:KSample
    - Latent, o
    - model, i
    - positive, i
...
`})]),tab1:l(({value:e,isActive:a})=>n[5]||(n[5]=[i("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md","data-title":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[i("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```nodeflow-list")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"- nodes")]),s(`
