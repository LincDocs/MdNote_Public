...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,35)]))}const v=i(t,[["render",a],["__file","02. 线程创建.html.vue"]]),c=JSON.parse('{"path":"/01.%20DesignAndDevelop/Develop/01.%20Language/C__/04.%20%E4%BC%98%E5%8C%96/%E5%A4%9A%E7%BA%BF%E7%A8%8B/02.%20%E7%BA%BF%E7%A8%8B%E5%88%9B%E5%BB%BA.html","title":"多线程 - 线程创建","lang":"zh-CN","frontmatter":{"description":"多线程 - 线程创建 方法简概 主线程从main()开始执行，创建的线程也需要有一个初始函数开始运行，当这个初始函数运行完毕时该线程结束 一般情况下当主线程执行完毕则其他子线程也会被强行终止（说的是thread方法，而detach线程方法可令主线程执行完毕后子线程继续执行） 线程创建方法 线程使用（thread对象） thread join detac...","head":[["meta",{"property":"og:url","content":"https://LincDocs.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/01.%20Language/C__/04.%20%E4%BC%98%E5%8C%96/%E5%A4%9A%E7%BA%BF%E7%A8%8B/02.%20%E7%BA%BF%E7%A8%8B%E5%88%9B%E5%BB%BA.html"}],["meta",{"property":"og:site_name","content":"MdNote_Public"}],["meta",{"property":"og:title","content":"多线程 - 线程创建"}],["meta",{"property":"og:description","content":"多线程 - 线程创建 方法简概 主线程从main()开始执行，创建的线程也需要有一个初始函数开始运行，当这个初始函数运行完毕时该线程结束 一般情况下当主线程执行完毕则其他子线程也会被强行终止（说的是thread方法，而detach线程方法可令主线程执行完毕后子线程继续执行） 线程创建方法 线程使用（thread对象） thread join detac..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-01-22T04:20:37.000Z"}],["meta",{"property":"article:author","content":"LincDocs"}],["meta",{"property":"article:modified_time","content":"2025-01-22T04:20:37.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"多线程 - 线程创建\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-01-22T04:20:37.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincDocs\\",\\"url\\":\\"https://github.com/LincDocs/MdNote_Public/\\"}]}"]]},"headers":[{"level":1,"title":"多线程 - 线程创建","slug":"多线程-线程创建","link":"#多线程-线程创建","children":[{"level":2,"title":"方法简概","slug":"方法简概","link":"#方法简概","children":[]},{"level":2,"title":"基本使用","slug":"基本使用","link":"#基本使用","children":[{"level":3,"title":"thread+join 例程","slug":"thread-join-例程","link":"#thread-join-例程","children":[]},{"level":3,"title":"thread+detach 例程","slug":"thread-detach-例程","link":"#thread-detach-例程","children":[]},{"level":3,"title":"joinable","slug":"joinable","link":"#joinable","children":[]}]},{"level":2,"title":"线程入口","slug":"线程入口","link":"#线程入口","children":[{"level":3,"title":"(1) 函数","slug":"_1-函数","link":"#_1-函数","children":[]},{"level":3,"title":"(2) 类对象 / 匿名对象","slug":"_2-类对象-匿名对象","link":"#_2-类对象-匿名对象","children":[]},{"level":3,"title":"(3) Lambda函数","slug":"_3-lambda函数","link":"#_3-lambda函数","children":[]},{"level":3,"title":"(4) 成员函数指针","slug":"_4-成员函数指针","link":"#_4-成员函数指针","children":[]}]},{"level":2,"title":"多个线程","slug":"多个线程","link":"#多个线程","children":[]}]}],"git":{"createdTime":1737519637000,"updatedTime":1737519637000,"contributors":[{"name":"Linc","email":"762699299@qq.com","commits":1}]},"readingTime":{"minutes":4.16,"words":1247},"filePathRelative":"01. DesignAndDevelop/Develop/01. Language/C++/04. 优化/多线程/02. 线程创建.md","localizedDate":"2025年1月22日","excerpt":"\\n<h2>方法简概</h2>\\n<p>主线程从main()开始执行，创建的线程也需要有一个<code>初始函数</code>开始运行，当这个初始函数运行完毕时该线程结束</p>\\n<p>一般情况下当主线程执行完毕则其他子线程也会被强行终止（说的是thread方法，而detach线程方法可令主线程执行完毕后子线程继续执行）</p>\\n<hr>\\n<p>线程创建方法</p>\\n<ul>\\n<li>线程使用（thread对象）\\n<ul>\\n<li>thread</li>\\n<li>join</li>\\n<li>detach</li>\\n<li>joinable</li>\\n</ul>\\n</li>\\n<li>其他创建线程的手法\\n<ul>\\n<li>类对象 / 匿名对象</li>\\n<li>Lambda表达式</li>\\n</ul>\\n</li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"01. DesignAndDevelop/Develop/01. Language/C++/04. 优化/多线程/02. 线程创建.md","value":{"title":"02. 线程创建","path":"01. DesignAndDevelop/Develop/01. Language/C++/04. 优化/多线程/02. 线程创建.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{v as comp,c as data};
