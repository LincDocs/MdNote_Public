import{_ as n,c as i,e as l,o as a}from"./app-Dt9PEj-q.js";const d={};function s(t,e){return a(),i("div",null,e[0]||(e[0]=[l(`<h1 id="设计模式" tabindex="-1"><a class="header-anchor" href="#设计模式"><span>设计模式</span></a></h1><p>大话设计模式-职责链模式</p><p>https://localhost.blog.csdn.net/article/details/90202435</p><p>大话设计模式-系列文章(共50篇)：</p><p>https://blog.csdn.net/qq_41113081/category_8723350.html</p><h2 id="错题" tabindex="-1"><a class="header-anchor" href="#错题"><span>错题</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>以下哪个模式可以利用一个对象，快速地生成一批对象？（）
抽象工厂模式
单例模式
原型模式.
简单工厂模式
