import{_ as l,c as e,e as a,a as i,b as s,o as n}from"./app-BdoQz9cf.js";const r="/MdNote_Public/assets/image%209-BUON3QE3.webp",h={};function d(p,t){return n(),e("div",null,t[0]||(t[0]=[a(`<h1 id="虚拟机的创建" tabindex="-1">虚拟机的创建</h1><h2 id="创建虚拟机" tabindex="-1">创建虚拟机</h2><h3 id="创建虚拟机方式" tabindex="-1">创建虚拟机方式</h3><p>比如我们要创建ubuntu 22.04的虚拟机，参考官网资料： <a href="https://app.vagrantup.com/ubuntu/boxes/jammy64" target="_blank" rel="noopener noreferrer">https://app.vagrantup.com/ubuntu/boxes/jammy64</a></p><h4 id="方式一-vagrantfile" tabindex="-1">方式一：Vagrantfile</h4><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># 1. 创建Vagrantfile文件，并填充内容</span></span>
