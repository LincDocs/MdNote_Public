import{_ as n,c as a,b as i,o as e}from"./app-BmPCYhWI.js";const l={};function p(d,s){return e(),a("div",null,[...s[0]||(s[0]=[i(`<h1 id="mysql" tabindex="-1">MySQL</h1><h1 id="目录" tabindex="-1">目录</h1><h1 id="sql命令" tabindex="-1">SQL命令</h1><h2 id="use-使用数据库" tabindex="-1">USE（使用数据库）</h2><div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-mysql"><span class="line"><span>-- SQL不分大小写，一般&#39;命令&#39;大写其他小写</span></span>
