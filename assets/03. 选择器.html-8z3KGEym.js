...
`),s("span",{class:"line"},[s("span",null,"  - file")])])]),s("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"})])],-1)])]),_:1})])}const m=p(k,[["render",v]]),A=JSON.parse('{"path":"/ProductDoc/AnyBlock/docs/zh/03.%20%E9%80%89%E6%8B%A9%E5%99%A8.html","title":"Selector (选择器)","lang":"zh-CN","frontmatter":{"description":"Selector (选择器) 很多人看到展示页面眼花缭乱的效果，认为 AnyBlock 提供的大量效果处理和渲染是这个插件的内容。 但这并非 AnyBlock 的精髓所在，AnyBlock 插件，看名字就知道，他的精髓在于任意地选择一段范围，并将这一段范围变为 “块” 即 AnyBlock 的精髓在于 —— 选择器 什么是选择器？ 这是插件中的一个重要...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Selector (选择器)\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/MdNote_Public/ProductDoc/AnyBlock/docs/zh/03.%20%E9%80%89%E6%8B%A9%E5%99%A8.html"}],["meta",{"property":"og:site_name","content":"MdNote_Public"}],["meta",{"property":"og:title","content":"Selector (选择器)"}],["meta",{"property":"og:description","content":"Selector (选择器) 很多人看到展示页面眼花缭乱的效果，认为 AnyBlock 提供的大量效果处理和渲染是这个插件的内容。 但这并非 AnyBlock 的精髓所在，AnyBlock 插件，看名字就知道，他的精髓在于任意地选择一段范围，并将这一段范围变为 “块” 即 AnyBlock 的精髓在于 —— 选择器 什么是选择器？ 这是插件中的一个重要..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":9.28,"words":2784},"filePathRelative":"ProductDoc/AnyBlock/docs/zh/03. 选择器.md","excerpt":"\\n<p>很多人看到展示页面眼花缭乱的效果，认为 AnyBlock 提供的大量效果处理和渲染是这个插件的内容。</p>\\n<p>但这并非 AnyBlock 的精髓所在，<code>AnyBlock</code> 插件，看名字就知道，他的精髓在于任意地选择一段范围，并将这一段范围变为 “块”</p>\\n<p>即 AnyBlock 的精髓在于 —— <strong>选择器</strong></p>\\n<h2>什么是选择器？</h2>\\n<p>这是插件中的一个重要概念，对于 markdwon 的局部解析渲染，有两个重要的步骤</p>\\n<ol>\\n<li>范围识别 (我将完成这一步骤的称为 <code>选择器</code>)</li>\\n<li>将这段范围中的内容进行处理或渲染 (我将完成这一步骤的称为 <code>处理器</code>)</li>\\n</ol>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[{"title":"README.show","link":"ProductDoc/AnyBlock/README.show.html"}],"localMap":{"nodes":[{"id":"ProductDoc/AnyBlock/docs/zh/03. 选择器.md","value":{"title":"03. 选择器","path":"ProductDoc/AnyBlock/docs/zh/03. 选择器.md","outlink":[],"backlink":["ProductDoc/AnyBlock/README.show.md"]}},{"id":"ProductDoc/AnyBlock/README.show.md","value":{"title":"README.show","path":"ProductDoc/AnyBlock/README.show.md","outlink":[],"backlink":[]}}],"links":[{"source":"ProductDoc/AnyBlock/README.show.md","target":"ProductDoc/AnyBlock/docs/zh/03. 选择器.md"}]}}}');export{m as comp,A as data};
