import{_ as r,c as o,e as p,d as t,a as s,w as a,r as k,o as c,b as i}from"./app-DDr6zmuB.js";const B={};function A(u,n){const d=k("VueFlow"),h=k("Tabs");return c(),o("div",null,[n[6]||(n[6]=p('<h1 id="nodeflow-列表语法" tabindex="-1"><a class="header-anchor" href="#nodeflow-列表语法"><span>NodeFlow 列表语法</span></a></h1><h2 id="一种基于markdown列表的便于输入的节点描述语法" tabindex="-1"><a class="header-anchor" href="#一种基于markdown列表的便于输入的节点描述语法"><span>一种基于Markdown列表的便于输入的节点描述语法</span></a></h2><p>新增一种能手写的格式，说真的有时设计语法比开发成就感还强……大家讨论讨论语法，看有没有什么可以优化的地方</p><ol><li>该语法可以和AnyBlock插件配合，从列表进行声明</li><li>参考了：JSON、JSONL、YAML、Mermaid/Mehrmaid 流程图语法</li></ol><h3 id="示例" tabindex="-1"><a class="header-anchor" href="#示例"><span>示例</span></a></h3>',5)),t(h,{id:"24",data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:a(({value:e,isActive:l})=>n[0]||(n[0]=[i("Plugin effect (插件效果)")])),title1:a(({value:e,isActive:l})=>n[1]||(n[1]=[i("md source code (md源码)")])),tab0:a(({value:e,isActive:l})=>[t(d,{type:"nodeflow-list",data:`- nodes
  - node1: KSample
    - Latent, o
    - model, i
    - positive, i
