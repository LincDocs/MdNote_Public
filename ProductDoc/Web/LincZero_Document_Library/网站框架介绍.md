...
- [LincZero.github.io](https://github.com/LincZero/LincZero.github.io) (integration)
  ...
  - VuePress extension
    ...
    - [~~仿文件侧边栏~~](https://github.com/LincZero/LincZero.github.io/tree/main/src/.vuepress/plugins/RootSidebar) (魔改)，组件替换 (后弃用，换用自研侧边栏)
    - [NodeFlow](https://github.com/LincZero/obsidian-node-flow) (自研, 2024)，用于节点工作流的显示与扩展
    - [onInitialized-json](https://github.com/LincZero/LincZero.github.io/tree/main/src/.vuepress/plugins/ExFormat) (自研)，格式扩展。对NodeFlow的增强，直接识别工作流json文件
    - [onInitialized-pdf](https://github.com/LincZero/LincZero.github.io/tree/main/src/.vuepress/plugins/ExFormat) (自研)，格式扩展。直接识别pdf库
    ...
    - [ReadEnhance](https://github.com/LincZero/LincZero.github.io/tree/main/src/.vuepress/plugins/ReadEnhance) (自研)，阅读增强。除了文本类布局，更多的是为非 `.md` 提供更好的展示效果 (如节点流、pdf等)
    - [BiGraph](https://github.com/LincZero/LincZero.github.io/tree/main/src/.vuepress/plugins/BiGraph) [原作位置](https://github.com/erduotong/erduotong.github.io/tree/main/src/.vuepress/plugins/BiGraph) (贡献)，图谱和反链
  - Workflows extension
